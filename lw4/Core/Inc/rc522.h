...
void MFRC522_CalculateCRC(uint8_t* pIndata, uint8_t len, uint8_t* pOutData);uint8_t MFRC522_SelectTag(uint8_t* serNum);
...
uint8_t MFRC522_CheckVersion(uint8_t* version);
